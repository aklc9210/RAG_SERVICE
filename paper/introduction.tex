...
This paper proposes an ontology-enhanced RAG framework for Vietnamese food IR. Our contributions are fourfold:
\begin{itemize}
  ...
  \item Three evaluation tasks isolating ontology contribution: class-based retrieval (200 queries), constrained substitution (100 cases with LLM-judge ground truth), and related-dish recommendation (200 dishes), with inter-annotator agreement reported (Section~\ref{sec:tasks}).
  \item A five-variant ablation with paired significance tests, providing direct evidence for the independent contribution of hierarchy, typed relations, and inference rules.
\end{itemize}
