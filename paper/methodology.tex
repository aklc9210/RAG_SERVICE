...
The ontology is injected into the dense-retrieval pipeline at three points, each targeting one of the failure modes identified in Section~\ref{sec:introduction}. Fig.~\ref{fig:pipeline} illustrates the overall architecture.
