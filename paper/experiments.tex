...
Task~2 uses three LLM judges (\textbf{Llama-3.1 8B}, \textbf{Gemma-2 9B}, \textbf{Mistral 7B}) scoring relatedness on a 0/1/2 scale with the following prompt, following prior LLM-as-judge evaluation work \cite{zheng2023judge, liu2023geval}:
